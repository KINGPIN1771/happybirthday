...
export default function Home() {
  ...
  const birthdayDate = new Date("July 11, 2025") // Change this date accordingly
  const audioRef = useRef(null)

  // For testing
  // const birthdayDate = new Date("2025-07-11T22:42:00+05:30")
  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-rose-100 to-purple-100 flex flex-col items-center justify-center p-4 overflow-hidden">
      ...
      <audio ref={audioRef} src="/happybirthday/birthday.mp3" preload="auto" loop />
