  ...
  return (
    <div className="flex flex-col items-center">
      ...
      >
        ...
        <h3 className="text-2xl sm:text-3xl font-bold text-center text-pink-600 mt-2">To You Swathi</h3>
      </motion.div>
          ...
          <AnimatePresence>
            ...
            >
              <div className="text-center">
                ...
                Pirandha naal nalvaazthukkal Swathi mol. Crush nu theriyum la... adhukku oru special wish😅
                </p>
                <p className="text-pink-600 font-medium">Un birthday la magicaana moments um, Unnai sirikka vaikkura santhosham-um irukka💖</p>
                <div className="flex justify-center">
                  <motion.div
                    animate={{
                      scale: [1, 1.2, 1],
      ...
      >
        <div className="text-center">
          ...
          Get ready … indha year full-on fun, drama, and nonsense varapogudhu!.
          </p>
